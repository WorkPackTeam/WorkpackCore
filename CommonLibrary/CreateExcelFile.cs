...
//        public static bool CreateExcelDocument(DataSet ds, string excelFilename,System.IO.MemoryStream stream,string ExportDescription )
//        {
//            try
//            {
...
//                using (SpreadsheetDocument document = SpreadsheetDocument.Create(stream, SpreadsheetDocumentType.Workbook, true))
//                {
//                    WriteExcelFile(ds, document,ExportDescription);
//                }
...
//        private static void WriteExcelFile(DataSet ds, SpreadsheetDocument spreadsheet, string ExptDescription)
//        {
//            //  Create the Excel file contents.  This function is used when creating an Excel file either writing 
//            //  to a file, or writing to a MemoryStream.
//            spreadsheet.AddWorkbookPart();
...
//                // save worksheet
//                WriteDataTableToExcelWorksheet(dt, newWorksheetPart, ExptDescription);
//                newWorksheetPart.Worksheet.Save();
...
//        private static void WriteDataTableToExcelWorksheet(DataTable dt, WorksheetPart worksheetPart, string ExptDescription)
//        {
//            var worksheet = worksheetPart.Worksheet;
//            var sheetData = worksheet.GetFirstChild<SheetData>();
...
//                DataColumn col = dt.Columns[colInx];
//                if (colInx == 0)
//                    AppendTextCell(excelColumnNames[colInx] + "1", ExptDescription, headerRow);
//                else
//                    AppendTextCell(excelColumnNames[colInx] + "1", "", headerRow);
//                IsNumericColumn[colInx] = (col.DataType.FullName == "System.Decimal") || (col.DataType.FullName == "System.Int32");
//            }
...
//            Cell cell = new Cell() { CellReference = cellReference, DataType = CellValues.String ,StyleIndex = 1 };
